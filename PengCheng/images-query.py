...
#     print(module_info)
"""
脚本用途：根据用户提供的镜像名称查询镜像uuid，并生成对应镜像信息
"""
import xlrd
import xlwt
import requests
...
headers = {"Content-Type": "application/json",
           ...
           "X-Auth-Token": "gAAAAABghQ2Et2o8FSYqtUIW1z9SzkYUqJmmSCtF48HwJh4h1rGJhJpvOr5B2KHC6vO68l330vVpF5Jk9ZdFVgehjy1X4itTPYp-KliwPzx3t71a7fizQ6Be0WNnPAdRCkbVKGz6tqSs21Z3xeVxFwDYephsAV5CSuvFnlE0Oiw_nZFfYz8jTiI"
           }
...
def generate_uuid_to_name(file_name):
    ...
    wb = xlrd.open_workbook('镜像列表3.xls')
    ...
    new_workbook.save('镜像列表3带uuid.xls')

def main():
    # request_image(url,'images3.json')
    # image_excel('images3.json','glance镜像信息表3.xls')
    generate_uuid_to_name('glance镜像信息表3.xls')
